          ...
          <div style={{
            ...
            <Link
              ...
              style={{
                ...
                fontSize: '1.1rem',
                textDecoration: 'none',
                color: isActive('/worldcup') ? theme.activeColor : theme.linkColor,
                transition: 'all 0.3s ease',
                padding: '0.75rem 1.25rem',
                borderRadius: '25px',
                position: 'relative',
                background: isActive('/worldcup') ? 'rgba(255, 255, 255, 0.1)' : 'transparent'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.color = theme.hoverColor;
                e.currentTarget.style.background = 'rgba(255, 255, 255, 0.1)';
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = isActive('/worldcup') ? theme.activeColor : theme.linkColor;
                e.currentTarget.style.background = isActive('/worldcup') ? 'rgba(255, 255, 255, 0.1)' : 'transparent';
                e.currentTarget.style.transform = 'translateY(0)';
              }}
              onFocus={(e) => e.currentTarget.style.outline = `2px solid ${theme.activeColor}`}
              onBlur={(e) => e.currentTarget.style.outline = 'none'}
            ...
            <Link
              ...
              style={{
                ...
                fontSize: '1.1rem',
                textDecoration: 'none',
                color: isActive('/takanon') ? theme.activeColor : theme.linkColor,
                transition: 'all 0.3s ease',
                padding: '0.75rem 1.25rem',
                borderRadius: '25px',
                position: 'relative',
                background: isActive('/takanon') ? 'rgba(255, 255, 255, 0.1)' : 'transparent'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.color = theme.hoverColor;
                e.currentTarget.style.background = 'rgba(255, 255, 255, 0.1)';
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = isActive('/takanon') ? theme.activeColor : theme.linkColor;
                e.currentTarget.style.background = isActive('/takanon') ? 'rgba(255, 255, 255, 0.1)' : 'transparent';
                e.currentTarget.style.transform = 'translateY(0)';
              }}
              onFocus={(e) => e.currentTarget.style.outline = `2px solid ${theme.activeColor}`}
              onBlur={(e) => e.currentTarget.style.outline = 'none'}
            ...
            <Link
              ...
              style={{
                ...
                fontSize: '1.1rem',
                textDecoration: 'none',
                color: isActive('/tzvatim') ? theme.activeColor : theme.linkColor,
                transition: 'all 0.3s ease',
                padding: '0.75rem 1.25rem',
                borderRadius: '25px',
                position: 'relative',
                background: isActive('/tzvatim') ? 'rgba(255, 255, 255, 0.1)' : 'transparent'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.color = theme.hoverColor;
                e.currentTarget.style.background = 'rgba(255, 255, 255, 0.1)';
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.color = isActive('/tzvatim') ? theme.activeColor : theme.linkColor;
                e.currentTarget.style.background = isActive('/tzvatim') ? 'rgba(255, 255, 255, 0.1)' : 'transparent';
                e.currentTarget.style.transform = 'translateY(0)';
              }}
              onFocus={(e) => e.currentTarget.style.outline = `2px solid ${theme.activeColor}`}
              onBlur={(e) => e.currentTarget.style.outline = 'none'}
          ...
          <div style={{
            ...
            <Link
              ...
              style={{
                ...
                padding: '1rem',
                borderRadius: '10px',
                backgroundColor: isActive('/worldcup') ? 'rgba(255, 255, 255, 0.1)' : 'transparent',
                transition: 'all 0.3s ease',
                display: 'flex',
                alignItems: 'center',
                gap: '0.75rem'
              ...
              onClick={() => setMobileMenuOpen(false)}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = isActive('/worldcup') ? 'rgba(255, 255, 255, 0.1)' : 'transparent'}
            >
              ⚽ מונדיאל
            </Link>
            <Link
              ...
              style={{
                ...
                padding: '1rem',
                borderRadius: '10px',
                backgroundColor: isActive('/takanon') ? 'rgba(255, 255, 255, 0.1)' : 'transparent',
                transition: 'all 0.3s ease',
                display: 'flex',
                alignItems: 'center',
                gap: '0.75rem'
              ...
              onClick={() => setMobileMenuOpen(false)}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = isActive('/takanon') ? 'rgba(255, 255, 255, 0.1)' : 'transparent'}
            >
              📜 תקנון
            </Link>
            <Link
              ...
              style={{
                ...
                padding: '1rem',
                borderRadius: '10px',
                backgroundColor: isActive('/tzvatim') ? 'rgba(255, 255, 255, 0.1)' : 'transparent',
                transition: 'all 0.3s ease',
                display: 'flex',
                alignItems: 'center',
                gap: '0.75rem'
              ...
              onClick={() => setMobileMenuOpen(false)}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = isActive('/tzvatim') ? 'rgba(255, 255, 255, 0.1)' : 'transparent'}
            >
              👥 צוותים
            </Link>
