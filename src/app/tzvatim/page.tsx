...
const teams = [
  { month: 'ינואר', members: ['אדיר חזן', 'עמית תירוש'] },
  { month: 'פברואר', members: ['אבי לוי', 'דני קרן'] },
  { month: 'מרץ', members: ['דודי אמסלם', 'ליאור טמיר', 'מומי שושן'] },
  { month: 'אפריל', members: ['משה מרקו', 'נדב חורי'] },
  { month: 'מאי', members: ['עופר גלעדי', 'אורן בנבנישתי'] },
  { month: 'יוני', members: ['רם אלמוג', 'רועי וגנר', 'רון דיקסון'] },
  { month: 'יולי', members: ['שגיא שנון', 'סהר אביאני'] },
  { month: 'אוגוסט', members: ['ספי בר', 'שלום מולדבסקי'] },
  { month: 'ספטמבר', members: ['שלום ספיר', 'שי זיידנברג', 'שולי מייקלס'] },
  { month: 'אוקטובר', members: ['טל שקד', 'יוסי חכם'] },
