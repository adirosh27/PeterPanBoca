...
const teams = [
  ...
  { month: 'פברואר', members: ['אדיר חזן', 'עמית תירוש'] },
  { month: 'מרץ', members: ['אבי לוי', 'דני קרן'] },
  { month: 'אפריל', members: ['דודי אמסלם', 'ליאור טמיר', 'מומי שושן'] },
  { month: 'מאי', members: ['משה מרקו', 'נדב חורי'] },
  { month: 'יוני', members: ['אורן בנבנישתי', 'רם אלמוג'] },
  { month: 'יולי', members: ['רועי וגנר', 'רון דיקסון', 'שגיא שנון'] },
  { month: 'אוגוסט', members: ['סהר אביאני', 'ספי בר'] },
  { month: 'ספטמבר', members: ['שלום ספיר', 'שי זיידנברג'] },
  { month: 'אוקטובר', members: ['שולי מייקלס', 'טל שקד', 'יוסי חכם'] },
